...
void SerialCmd() {
  ...
  if (inputString.length() > 1) {
    ...
    else if (task.indexOf("mintemp") == 0 ) { // tbv alarmbij te lage temperatuur
      task.replace("mintemp=", "");
      storeMintemp(task);
    }

    else if (task.indexOf("minUVI") == 0 ) { // tbv alarmbij te lage temperatuur
      task.replace("minUVI=", "");
      storeMinuvIndex(task);
    }

    else if (task.indexOf("maxUVI") == 0 ) { // tbv alarmbij te lage temperatuur
      task.replace("maxUVI=", "");
